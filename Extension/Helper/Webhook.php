...
class Webhook extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    private $actionmapping = array(
        ...
        'quote/create' => 'Magento\Customer\Api\AccountManagementInterface::isEmailAvailable',
        'quote/update' => 'Magento\Customer\Api\AccountManagementInterface::isEmailAvailable',
